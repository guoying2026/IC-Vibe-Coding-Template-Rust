...
const translations: Translations = {
  ...
  "How Earn & Borrow Work on ICP DeFi": { en: "How Earn & Borrow Work on ICP DeFi", zh: "ICP DeFi 的收益与借贷原理" },
 "This page explains the underlying logic and advantages of the Earn and Borrow features on our platform.": { en: "This page explains the underlying logic and advantages of the Earn and Borrow features on our platform.", zh: "本页介绍本平台收益（Earn）和借贷（Borrow）功能的底层逻辑与优势。" },
 "Earn: How You Earn Yield": { en: "Earn: How You Earn Yield", zh: "收益：如何赚取收益" },
"Deposit Assets": { en: "Deposit Assets", zh: "存入资产" },
"You supply supported assets (e.g., BTC, ETH) into the platform's vaults.": { en: "You supply supported assets (e.g., BTC, ETH) into the platform's vaults.", zh: "您将支持的资产（如BTC、ETH）存入平台金库。" },
"Assets are Matched to Borrowers": { en: "Assets are Matched to Borrowers", zh: "资产与借款人撮合" },
"Your supplied assets are algorithmically matched to borrowers, maximizing utilization and yield.": { en: "Your supplied assets are algorithmically matched to borrowers, maximizing utilization and yield.", zh: "您的资产通过算法与借款人撮合，提升利用率和收益。" },
"Earn Interest": { en: "Earn Interest", zh: "赚取利息" },
"You earn interest paid by borrowers, with rates determined by market supply and demand.": { en: "You earn interest paid by borrowers, with rates determined by market supply and demand.", zh: "您获得借款人支付的利息，利率由市场供需决定。" },
"Advantages": { en: "Advantages", zh: "优势" },
"Non-custodial, assets always in your control.": { en: "Non-custodial, assets always in your control.", zh: "非托管，资产始终归您所有。" },
"Competitive yields, optimized by smart matching.": { en: "Competitive yields, optimized by smart matching.", zh: "收益有竞争力，智能撮合优化。" },
"Transparent, on-chain operations.": { en: "Transparent, on-chain operations.", zh: "透明，链上操作。" },
"Borrow: How You Borrow Assets": { en: "Borrow: How You Borrow Assets", zh: "借贷：如何借出资产" },
"Provide Collateral": { en: "Provide Collateral", zh: "提供抵押品" },
"Deposit supported assets as collateral (e.g., BTC, ETH).": { en: "Deposit supported assets as collateral (e.g., BTC, ETH).", zh: "将支持的资产作为抵押品存入（如BTC、ETH）。" },
"Borrow Against Collateral": { en: "Borrow Against Collateral", zh: "以抵押品借贷" },
"Borrow other assets up to a safe loan-to-value (LTV) ratio.": { en: "Borrow other assets up to a safe loan-to-value (LTV) ratio.", zh: "在安全的抵押率范围内借出其他资产。" },
"Repay and Withdraw": { en: "Repay and Withdraw", zh: "还款与提取" },
"Repay your loan to unlock and withdraw your collateral.": { en: "Repay your loan to unlock and withdraw your collateral.", zh: "还清贷款后可解锁并提取抵押品。" },
"Flexible borrowing, multiple supported assets.": { en: "Flexible borrowing, multiple supported assets.", zh: "灵活借贷，支持多种资产。" },
"Over-collateralized, reducing risk of bad debt.": { en: "Over-collateralized, reducing risk of bad debt.", zh: "超额抵押，降低坏账风险。" },
"Transparent interest rates and liquidation rules.": { en: "Transparent interest rates and liquidation rules.", zh: "透明的利率和清算规则。" },
"FAQ": { en: "FAQ", zh: "常见问题" },
"Is my asset safe?": { en: "Is my asset safe?", zh: "我的资产安全吗？" },
"All operations are non-custodial and on-chain. You always control your assets.": { en: "All operations are non-custodial and on-chain. You always control your assets.", zh: "所有操作均为非托管且链上执行，资产始终归您所有。" },
"How is the interest rate determined?": { en: "How is the interest rate determined?", zh: "利率如何决定？" },
"Interest rates are dynamically adjusted based on market supply and demand.": { en: "Interest rates are dynamically adjusted based on market supply and demand.", zh: "利率根据市场供需动态调整。" },
"What happens if my collateral value drops?": { en: "What happens if my collateral value drops?", zh: "如果我的抵押品价值下跌会怎样？" },
"If your collateral value falls below the liquidation threshold, your position may be liquidated to protect the protocol.": { en: "If your collateral value falls below the liquidation threshold, your position may be liquidated to protect the protocol.", zh: "如果抵押品价值低于清算阈值，您的仓位可能会被清算以保护协议安全。" },
