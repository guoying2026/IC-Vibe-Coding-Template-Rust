  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        {depositState && (
          <div className="mt-6 p-4 rounded bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
            ...
            <div className="text-xs text-gray-700 dark:text-gray-200">
              ...
              }[depositState.status] || depositState.status}</div>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        <div className="text-sm text-blue-600 dark:text-blue-400">当前余额</div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="amount" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {activeTab === 'deposit' ? '存入金额' : '取出金额'} (ckBTC)
          </label>
          <input
            type="number"
            id="amount"
        ...
        >
          {isLoading ? (
            ...
            activeTab === 'deposit' ? '存入 ckBTC' : '取出 ckBTC'
          )}
        </button>
      </form>
      ...
      {/* 快速金额按钮 */}
      <div className="mt-4">
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">快速金额:</p>
